...
sys.path.insert(0, str(Path(__file__).parent.parent / "novocontrol_toolbox" / "src")) # Pfad zum Novocontrol_Toolbox Paket hinzufügen (novocontrol_toolbox muss im übergeordneten Verzeichnis liegen) # falls nicht installiert
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        init_dir = Path(script_dir / "tests/testdata")
